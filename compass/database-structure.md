...
| 기업 간 관계의 체계적 관리 | 관계 정보를 별도 구조로 관리하고 이력 보존 | 관계 테이블 + 유효 기간 |
...
## 3. 기업 간 관계의 체계적 관리: 관계 테이블과 유효 기간

### 문제

- 금융지주사 분석 시 자회사 현황 파악 필요 (관계 유형, 지분율 등)
- 관계가 시간에 따라 변동하므로 특정 시점 기준 조회가 가능해야 함

### 설계

기업 간 관계를 별도 테이블로 관리하고 유효 기간을 저장.
...
- 특정 시점 기준 그룹 구조 조회 (예: "2020년 말 기준 KB금융지주 자회사 목록")
- M&A 실사, 그룹 구조 변화 추적 등에 활용
